...
static const _ForkSpeed_type_support_symbol_names_t _ForkSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bolide_interfaces, msg, ForkSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bolide_interfaces, msg, ForkSpeed)),
  }
};
...
{
  return &::bolide_interfaces::msg::rosidl_typesupport_cpp::ForkSpeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bolide_interfaces, msg, ForkSpeed)() {
  return get_message_type_support_handle<bolide_interfaces::msg::ForkSpeed>();
}
