...
#include "bolide_interfaces/msg/detail/fork_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const bolide_interfaces::msg::ForkSpeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bolide_interfaces::msg::ForkSpeed & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bolide_interfaces::msg::ForkSpeed;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bolide_interfaces
max_serialized_size_key_ForkSpeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const bolide_interfaces::msg::ForkSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bolide_interfaces::msg::ForkSpeed *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ForkSpeed__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bolide_interfaces::msg::ForkSpeed *>(
...
static size_t _ForkSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ForkSpeed(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ForkSpeed__callbacks = {
...
static rosidl_message_type_support_t _ForkSpeed__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ForkSpeed__callbacks,
...
{
  return &bolide_interfaces::msg::typesupport_fastrtps_cpp::_ForkSpeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bolide_interfaces, msg, ForkSpeed)() {
  return &bolide_interfaces::msg::typesupport_fastrtps_cpp::_ForkSpeed__handle;
}
